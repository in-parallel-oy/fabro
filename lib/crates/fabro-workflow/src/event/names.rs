...
pub fn event_name(event: &Event) -> &'static str {
    match event {
        ...
        Event::AgentAcpToolCall { .. } => "agent.acp.tool_call",
        Event::AgentAcpToolCallUpdate { .. } => "agent.acp.tool_call_update",
        Event::AgentAcpMessage { .. } => "agent.acp.message",
        Event::AgentAcpThought { .. } => "agent.acp.thought",
        Event::AgentAcpPlan { .. } => "agent.acp.plan",
        Event::AgentAcpUserMessage { .. } => "agent.acp.user_message",

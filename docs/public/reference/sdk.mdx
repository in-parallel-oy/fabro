...
[dependencies]
fabro-auth = { git = "https://github.com/in-parallel-oy/fabro" }
fabro-agent = { git = "https://github.com/in-parallel-oy/fabro" }
fabro-llm = { git = "https://github.com/in-parallel-oy/fabro" }
fabro-model = { git = "https://github.com/in-parallel-oy/fabro" }

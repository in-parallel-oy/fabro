...
Every agent node uses a **backend** that determines how Fabro interacts with the LLM. There are three options:
...
| Capability | API backend | ACP backend | CLI backend |
|---|---|---|---|

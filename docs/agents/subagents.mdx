...
<Note>
Sub-agents are only available with the [API agent](/core-concepts/agents#api-agent-default) (the default). Agents using the [CLI agent](/core-concepts/agents#cli-agent) cannot spawn sub-agents.
</Note>

...
- **Larger features or changes** -- Please open a [GitHub Issue](https://github.com/in-parallel-oy/fabro/issues) or start a [Discussion](https://github.com/in-parallel-oy/fabro/discussions) first so we can align on the approach before you invest significant time.
- **Prefer not to write the code yourself?** -- As an alternative to opening a PR, you can file a [GitHub Issue](https://github.com/in-parallel-oy/fabro/issues) describing the bug or feature. A Fabro maintainer will implement it (supervising AI coding agents and workflows) and include you as a co-author on the commit that lands the change.
